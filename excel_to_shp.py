...
if st.session_state.df is not None:      
    ...
    lat_col = st.selectbox("Select Latitude Column", columns, index=st.session_state.lat_col if st.session_state.lat_col in columns else 0)      
    lon_col = st.selectbox("Select Longitude Column", columns, index=st.session_state.lon_col if st.session_state.lon_col in columns else 0)      
